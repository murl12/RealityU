 ...
 *  5/5/2014
 *  
 *  edit by James Hammond 
 *  lines 278-275 && 317-323
 *  09/26/2014
 ********************************************************************/
...
public class ProcessMarried {	
	...
	public List<Survey> doProcess(List<Survey> surveysList) {
		...
		//Can use any survey in surveysList to get Group ID (all surveys have same group id)
	...
	/**
	 * Return list of divorced males
	 */
	public List<Survey> getDivorcedMales(){
		return listOfDivorcedMales;
	}// end getDivorcedMales() method
	...
	/**
	 * Return list of divorced females
	 */
	public List<Survey> getDivorcedFemales(){
		return listOfDivorcedFemales;
	}
