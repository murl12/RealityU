...
public class GroupTest {
	...
	public void testGroup2() {
		...
		Group instance = new Group(0, "a", "b", "c", "d", "e", "f", "g", "h",
				"i", "j");
		String result = instance.getId() + instance.getName()
				+ instance.getCreated() + instance.getModified()
				+ instance.getHighschool() + instance.getTeacher()
				+ instance.getClassPeriod() + instance.getSurveyStartDate()
				+ instance.getSurveyEndDate() + instance.getEventDate()
				+ instance.getStudentAccessCode();
	...
	public void testGroup3() {
		System.out
				.println("Test Group constructor: without Student Access Code");
	...
	public void testGenerateStudentAccessCode() {
		System.out
				.println("Test Group generateStudentAccessCode() method: generate different codes");
		Group g = new Group();
