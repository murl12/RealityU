...
public class EditOccupationServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			// Since we're appending the Occupation ID on the button name, we
			// don't know the exact parameter name
			// Get all parameters from form to find out which button was used to
			// submit form
			...
			if (buttonID.equals("delete")) {
				...
				if (request.getParameter("submit") != null) {
					// Add New Occupation, set Occupation to null (for blank
					// values)
					editOccp = null;
