...
public class Occupation {
	 ...
	 * 
	 * @param marAnnualTax
	 *            ; marMonthlyTax: calculated value marAfterTax: calculated
	 *            value
	 * 
	 * @param sinAnnualTax
	 *            ; sinMonthlyTax: calculated value sinAfterTax: calculated
	 *            value
	 * 
	 * @param gpa
	 *            ;
	...
	public Occupation(int id, String name, String type, String industry,
		...
		this.marAnnualTax = marAnnualTax;
		// Calculated value, rounded to 2 decimals
		this.marMonthlyTax = (double) Math
				.round((this.marAnnualTax / 12) * 100) / 100;
		// Calculated value, rounded to 2 decimals
		this.marAfterTax = (double) Math
				.round((this.monGrossSal - this.marMonthlyTax) * 100) / 100;
		this.sinAnnualTax = sinAnnualTax;
		// Calculated value, rounded to 2 decimals
		this.sinMonthlyTax = (double) Math
				.round((this.sinAnnualTax / 12) * 100) / 100;
		// Calculated value, rounded to 2 decimals
		this.sinAfterTax = (double) Math
				.round((this.monGrossSal - this.sinMonthlyTax) * 100) / 100;
		this.gpaCategory = gpaCategory;
		this.loan = loan;
	}
	...
	/**
	 * @param sinMonthylyTax
	 *            the sinMonthylyTax to set
	 */
	...
	public static void main(String[] args) {
		...
		Occupation o = new Occupation(0, "Actor", "Entertainment",
				"Entertainment", "Entertainment", 15205.72, 986.00, 679.00, 3,
				1000.00);
		o.display();
	} // end main()
}