...
public class Group {
	 ...
	 */
	public Group(int id, String name, String created, String modified,
	...
	/**
	 * Constructor with all parameters except studentAccessCode which is
	 * automatically generated via the generateStudentAccessCode() method
	 * 
	 * @param id
	 * @param name
	 * @param created
	...
	public String generateStudentAccessCode(int length) {
		...
		System.out.println("Checked dbase for match to code (0=no match): "
				+ lstGrp.size());
		if (lstGrp.size() != 0) {
	...
	/**
	 * Generates random Student Access Code, and checks for duplicates in dbase.
	 * Implements method overloading, no length parameter here. Length is set as
	 * default value of 8.
	 * 
	 * @return Returns a String student access code.
	 */
