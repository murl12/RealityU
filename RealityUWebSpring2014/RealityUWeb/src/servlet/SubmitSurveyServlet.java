            	...
            	//Set obj values for Session later
             	...
             	category = "";
	            	...
	            	if (request.getParameter("editSurvey") == null) {
			            ...
			            //Submit survey
			            //Create holder Survey obj to hold form data values. With id=0 
			            sd1.insert(fName, lName, dob, Double.parseDouble(gpa), gender, groupID, education, prefJob, "", married, 0, children,
		        		  Integer.parseInt(numChild), cCards, cCardUses,  groceries,  clothing, home, vehicle,
		        		  0.0, 0.0, save, entertainment); 
				        ...
				        surveyMsg = "Thank you, " + s1.getFname() + ". Your survey has been submitted successfully.";
